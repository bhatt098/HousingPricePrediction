...
class ModelFactory:
    ...
    @staticmethod
    def class_for_name(module_name:str, class_name:str):  #this is for importing module and class
        try:
            
            module = importlib.import_module(module_name)#importing module
            # get the class, will raise AttributeError if class cannot be found
            # logging.info(f"Executing command: from {module} import {class_name}")
            class_ref = getattr(module, class_name)  #from module its importing class ex linear regression
            return class_ref
        except Exception as e:
            raise HousingException(e, sys) from e
    ...
    def get_initialized_model_list(self) -> List[InitializedModelDetail]:
        ...
        try:
            ...
            for model_serial_number in self.models_initialization_config.keys():
                ...
                model = model_obj_ref()  #object calculated like linearregression()
